...
export class ArticleApiService {
  ...
  public createArticle$(body: any): Observable<any> {
    return this.ajax.post("http://localhost:3000/article", body);
  }

  // 获取文章详情
  public queryArticleItem$(id: string): Observable<any> {
    return this.ajax.get(`http://localhost:3000/article/${id}`);
  }

  // 更新文章
  public updateArticleItem$(id: string, body: any): Observable<any> {
    return this.ajax.put(`http://localhost:3000/article/${id}`, body);
  }
}
